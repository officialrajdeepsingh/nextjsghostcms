...
function Search() {
  ...
  console.log(' setSearch:', data.item)
  return (
    <Popover.Root>
        ...
        >
          ...
          <div className='my-2'>
            ...
            <div className="relative">
              ...
              <button type="submit" onClick={submitData} className="text-white absolute right-2.5 bottom-2.5 bg-blue-600 hover:bg-blue-800 outline-none font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700">Search</button>
